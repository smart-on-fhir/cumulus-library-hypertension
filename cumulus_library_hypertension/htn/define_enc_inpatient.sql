...
,('http://www.ama-assn.org/go/cpt', '99251', 'Inpatient consultation for a new or established patient, which requires these 3 key components: A problem focused history; A problem focused examination; and Straightforward medical decision making. Counseling and/or coordination of care with other physicians, other qualified health care professionals, or agencies are provided consistent with the nature of the problem(s) and the patient-s and/or family-s needs. Usually, the presenting problem(s) are self limited or minor. Typically, 20 minutes are spent at the bedside and on the patient-s hospital floor or unit.')
...
,('http://snomed.info/sct', '48311003', 'Veteran-s administration hospital (environment)')
...
,('http://snomed.info/sct', '82242000', 'Children-s hospital (environment)')
