...
def count_prevalence_rx(duration=None):
    view_name = table('count_prevalence_rx', duration)
    from_table = table('prevalence_rx')
    cols = ['category_code',
            'rx_display',
            'hypertension',
            'hypertension_lab',
